"""
    N-body simulation.
    2. Using alternatives to membership testing of lists.
    Time: Average(315.915, 315.047, 270.888) =  300.6167 sec
    Improvement: 310.4767/300.6167 = 1.032799 x
    Rank: 3rd
"""
import time
...
if __name__ == '__main__':
    t = time.time()
    nbody(100, 'sun', 20000)
    print("nbody_2.py %.3f" % (time.time()-t))