"""
    N-body simulation.
    4. Using data aggregation to reduce loop overheads
    Time: Average(318.011, 274.594, 268.616) = 287.0737 sec
    Improvement: 310.4767/287.0737 =  1.081523x
    Rank: 2nd
"""
import time
...
if __name__ == '__main__':
    t = time.time()
    nbody(100, 'sun', 20000)
    print("nbody_4.py %.3f" % (time.time()-t))